...
namespace GoodCharmePerfume.GUI.Admin.Category
{
    public partial class fCategory : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            txtCategoryID.Text = ProductTypeDAO.Instance.GetNextMaLoaiSP();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ProductTypeDAO.Instance.UpdateProductType(txtCategoryID.Text, txtCategoryName.Text))
                {
                    MessageBox.Show("Đã chỉnh sửa loại sản phẩm thành công.", "Thông báo", MessageBoxButtons.OK);
                    LoadCategoryList();
                }
                else
                {
                    MessageBox.Show("Đã xảy ra lỗi khi chỉnh sửa loại sản phẩm.", "Thất bại", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        {
            if (MessageBox.Show("Bạn muốn xóa thể loại sản phẩm này? Tất cả thông tin liên quan cũng sẽ bị xóa.\r\n\r\nBạn có thực sự muốn xóa?", "Thông báo",
                    MessageBoxButtons.OKCancel, MessageBoxIcon.Information) == DialogResult.OK)
            {
                if (ProductTypeDAO.Instance.DeleteProductType(txtCategoryID.Text))
                {
                    MessageBox.Show("Đã xoá thể loại sản phẩm thành công.", "Thông báo", MessageBoxButtons.OK);
                    LoadCategoryList();
                }
                else
                {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ProductTypeDAO.Instance.InsertProductType(txtCategoryName.Text))
                {
                    MessageBox.Show("Đã thêm loại sản phẩm thành công.", "Thông báo", MessageBoxButtons.OK);
                    LoadCategoryList();
                    pnlConfirm.Visible = false;
                    pnlControls.Visible = true;
                }
                ...
                {
                    MessageBox.Show("Đã xảy ra lỗi khi thêm loại sản phẩm.", "Thất bại", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
