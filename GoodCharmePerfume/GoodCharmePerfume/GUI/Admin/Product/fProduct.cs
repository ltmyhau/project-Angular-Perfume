...
namespace GoodCharmePerfume.GUI.Admin.Product
{
    public partial class fProduct : Form
    {
        ...
        private void CustomizeDataGridView()
        {
            ...
            dgvProduct.Columns.Add(editImageColumn);
        ...
        private void dgvProduct_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == dgvProduct.Columns["EditColumn"].Index)
            {
                fAddEditProduct f = new fAddEditProduct();
                f.Text = "Chỉnh sửa thông tin sản phẩm";
                f.LoadData(dgvProduct.Rows[e.RowIndex]);
                f.ShowDialog();
            }

            if (e.ColumnIndex == dgvProduct.Columns["DeleteColumn"].Index)
            {
                ...
                {
                    string maSP = dgvProduct.Rows[e.RowIndex].Cells["MaSP"].Value.ToString();
