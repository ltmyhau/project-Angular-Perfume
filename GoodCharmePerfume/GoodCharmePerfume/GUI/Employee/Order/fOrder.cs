...
namespace GoodCharmePerfume.GUI.Employee.Order
{
    public partial class fOrder : Form
    {
        ...
        private void SetColumnWidthsInPercentage()
        {
            ...
            dgvOrder.Columns["MaDH"].Width = (int)(0.135 * totalWidth);
            dgvOrder.Columns["HoTenKH"].Width = (int)(0.2 * totalWidth);
            dgvOrder.Columns["HoTenNV"].Width = (int)(0.2 * totalWidth);
            dgvOrder.Columns["NgayDat"].Width = (int)(0.15 * totalWidth);
            dgvOrder.Columns["TinhTrang"].Width = (int)(0.15 * totalWidth);
            dgvOrder.Columns["TenPTTT"].Width = (int)(0.15 * totalWidth);
